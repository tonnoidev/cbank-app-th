...
public class SummaryDialyDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("สรุปรายวันทั่วไป");
        ...
        tbIncome.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1. รับโอนเงินเข้าบัญชี ธกส.", "0.00"},
                {"(เงินรับฝาก)เลขที่บัญชี", "0.00"},
                {"(เงินกู้)เลขที่บัญชี", "0.00"},
                {"(เงินค่าหุ้น)เลขที่บัญชี", "0.00"},
                {"(เงินออมสวัสดิการ)เลขที่บัญชี.", "0.00"}
            },
            new String [] {
                "รายการ", "จำนวน"
            }
        ...
        tbExpense.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1. สั่งจ่ายเงินกู้เข้าบัญชีสมาชิก", "0.00"},
                {"2. สั่งจ่ายเงินกู้ชำระหนี้", "0.00"}
            },
            new String [] {
                "รายการ", "จำนวน"
            }

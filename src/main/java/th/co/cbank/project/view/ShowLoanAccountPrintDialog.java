...
public class ShowLoanAccountPrintDialog extends BaseDialogSwing {
    ...
    public ShowLoanAccountPrintDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tbAccountList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ลำดับ", "เลขที่บัญชี", "ชื่อ", "นามสกุล"
            }
        ) {
        ...
        if (tbAccountList.getColumnModel().getColumnCount() > 0) {
            ...
            tbAccountList.getColumnModel().getColumn(2).setPreferredWidth(150);
            tbAccountList.getColumnModel().getColumn(3).setPreferredWidth(250);
        }

...
public class GroupAlertDialog extends BaseDialogSwing {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("เช่น ");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("ให้ขึ้นต้นคำนำหน้าด้วย");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("ตามด้วย ");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("และตามด้วย ");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("การกำหนดรหัสสมาชิกกลุ่ม");
        ...
        jLabel7.setText("วันเดือนปี (พ.ศ.)");

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel8.setText(" ที่มาสมัคร");

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 0, 0));
        jLabel9.setText("running 2 หลักในวันนั้นๆ !!!");
